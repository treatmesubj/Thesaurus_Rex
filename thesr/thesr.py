...
def get_random_word():
    soup = BeautifulSoup(
        requests.get("https://www.merriam-webster.com/word-of-the-day/calendar").text,
        "html.parser",
    )
...
def get_defs(word):
    soup = BeautifulSoup(
        requests.get(f"https://www.merriam-webster.com/dictionary/{word}").text,
        "html.parser",
    )
...
def get_etymology(word):
    soup = BeautifulSoup(
        requests.get(f"https://www.etymonline.com/word/{word}").text, "html.parser"
    )
